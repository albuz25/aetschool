...
export function QuickLeadForm() {
  return (
    <div className="rounded-2xl border border-border bg-white p-4 text-foreground shadow-xl sm:p-7">
      ...
      <div className="mt-3 flex items-center gap-2 text-[11px] text-foreground sm:mt-4 sm:text-xs">
